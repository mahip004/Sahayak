...
const Header = () => {
  ...
  const [isUserMenuOpen, setIsUserMenuOpen] = useState(false);  // For toggling user/community menu
  ...
  const toggleUserMenu = () => {
    setIsUserMenuOpen(!isUserMenuOpen);  // Toggle user/community menu
  };
    ...
    >
      <Link to="/" className="w-[80px]">
        <img
          ...
          loading="eager"
        />
        <h1 style={{ fontWeight: 600, fontSize: 20,}}>SAHAYAK</h1>
      ...
      >
        ...
        <div className="relative flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between gap-4 lg:gap-8 mt-4 md:mt-0">
          <button
            ...
            onClick={toggleUserMenu} // Toggle the dropdown
          >
            User/Community
          </button>
